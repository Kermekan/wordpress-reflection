...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'wordpress_reflection_backup_3beb17b40bd344462029_20220622112932_archive.zip';
	const ARCHIVE_SIZE		 = '1071899';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '3beb17b-22112932';
    const SECONDARY_PACKAGE_HASH = '96b3ba4-22112932';
	const VERSION			 = '1.4.6';
